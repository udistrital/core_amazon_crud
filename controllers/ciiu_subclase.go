...
// URLMapping ...
func (c *CiiuSubclaseController) URLMapping() {
...
// @Param	body		body 	models.CiiuSubclase	true		"body for CiiuSubclase content"
// @Success 201 {int} models.CiiuSubclase
...
// @Success 200 {object} models.CiiuSubclase
...
// @Failure 403
// @router / [get]
func (c *CiiuSubclaseController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllCiiuSubclase(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = l
