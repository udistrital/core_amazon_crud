...
// URLMapping ...
func (c *CiiuDivisionController) URLMapping() {
...
// @Param	body		body 	models.CiiuDivision	true		"body for CiiuDivision content"
// @Success 201 {int} models.CiiuDivision
...
// @Success 200 {object} models.CiiuDivision
...
// @Failure 403
// @router / [get]
func (c *CiiuDivisionController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllCiiuDivision(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = l
