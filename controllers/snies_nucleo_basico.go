...
// URLMapping ...
func (c *SniesNucleoBasicoController) URLMapping() {
...
// @Param	body		body 	models.SniesNucleoBasico	true		"body for SniesNucleoBasico content"
// @Success 201 {int} models.SniesNucleoBasico
...
// @Success 200 {object} models.SniesNucleoBasico
// @Failure 403 :id is empty
// @router /:id [get]
func (c *SniesNucleoBasicoController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetSniesNucleoBasicoById(id)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = v
...
// @Failure 403
// @router / [get]
func (c *SniesNucleoBasicoController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllSniesNucleoBasico(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = l
