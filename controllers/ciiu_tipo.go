...
// URLMapping ...
func (c *CiiuTipoController) URLMapping() {
...
// @Param	body		body 	models.CiiuTipo	true		"body for CiiuTipo content"
// @Success 201 {int} models.CiiuTipo
// @Failure 403 body is empty
// @router / [post]
func (c *CiiuTipoController) Post() {
	var v models.CiiuTipo
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddCiiuTipo(&v); err == nil {
...
// @Success 200 {object} models.CiiuTipo
...
// @Failure 403
// @router / [get]
func (c *CiiuTipoController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllCiiuTipo(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = l
